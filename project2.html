...
<head>
    ...
    <title>Simplee Supplements — John Carlo Salva</title>
...
<body>
    ...
    <div class="project-hero">
        <div class="hero-inner">
            <div>
                <div class="project-eyebrow">Frontend · Landing Page</div>
                <h1 class="project-title">Simplee<br><span>Supplements</span></h1>
                <p class="project-short-desc">A clean and modern landing page designed for a supplements brand, focused on product presentation, conversion-optimized layout, and mobile-first responsive design.</p>
            </div>
            <div class="hero-meta">
                <div class="meta-card">
                ...
                <div class="meta-card">
                    ...
                    <div class="meta-value">Landing Page · Frontend</div>
                </div>
                <div class="meta-card">
    ...
    <div class="project-body">
        ...
        <div class="screenshot-section reveal">
            ...
            <div class="screenshot-main" id="mainShot" onclick="openLightbox()">
                <div class="browser-bar">
                    ...
                    <div class="browser-url">simplee-supplements.com</div>
                </div>
                <img src="simplee/simplee1.png" class="screenshot-img" id="mainImg" alt="Simplee Supplements Screenshot">
                <div class="zoom-hint"><i class="fas fa-search-plus"></i></div>
            </div>

            <!-- Thumbnails -->
            <div class="thumb-strip">
                <div class="thumb active" onclick="setActive(this, 'simplee/simplee1.png')">
                    <img src="simplee/simplee1.png" alt="Screenshot 1">
                </div>
                <div class="thumb" onclick="setActive(this, 'simplee/simplee2.png')">
                    <img src="simplee/simplee2.png" alt="Screenshot 2">
                </div>
                <div class="thumb" onclick="setActive(this, 'simplee/simplee3.png')">
                    <img src="simplee/simplee3.png" alt="Screenshot 3">
                </div>
            </div>
        </div>
        ...
        <div class="content-grid">
            <div class="desc-block reveal">
                ...
                <p class="desc-text">Simplee Supplements is a frontend landing page project built for a health and wellness brand. The goal was to create a visually compelling, conversion-focused page that clearly communicates the brand's products and value proposition.</p>
                <p class="desc-text">The design prioritizes clean typography, strong product visuals, and a smooth user experience across all screen sizes — from mobile to desktop.</p>
                ...
                <ul class="feature-list">
                    <li>Hero section with strong CTA and product highlight</li>
                    <li>Product showcase with clean card-based layout</li>
                    <li>Benefits and features section with icon highlights</li>
                    <li>Testimonials / social proof section</li>
                    <li>Fully responsive, mobile-first design</li>
                    <li>Smooth scroll animations and hover interactions</li>
                </ul>
            </div>
            ...
            <div class="sidebar">
                ...
                <div class="sidebar-card reveal" style="transition-delay:0.15s">
                    ...
                    <div class="info-row"><span class="info-key">Category</span><span class="info-val">Landing Page</span></div>
                ...
                <div class="cta-card reveal" style="transition-delay:0.2s">
                    <h4>Need a landing page?</h4>
                    <p>Let's build a high-converting page for your brand.</p>
