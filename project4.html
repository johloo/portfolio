...
<head>
    ...
    <title>UGC Management System — John Carlo Salva</title>
    ...
    <div class="project-hero">
        <div class="hero-inner">
            <div>
                ...
                <h1 class="project-title">UGC<br><span>Management System</span></h1>
                <p class="project-short-desc">A full-featured web application for managing UGC creators — tracking outreach, content pipeline, deliverables, and payments in one centralized platform built with PHP and MySQL.</p>
            </div>
            <div class="hero-meta">
                <div class="meta-card">
                ...
                <div class="meta-card">
                    ...
                    <div class="meta-value">UGC Management · Web App</div>
                </div>
                <div class="meta-card">
    ...
    <div class="project-body">
        ...
        <div class="screenshot-section reveal">
            ...
            <div class="screenshot-main" id="mainShot" onclick="openLightbox()">
                <div class="browser-bar">
                    ...
                    <div class="browser-url">synovatic.space/ugc</div>
                </div>
                <!-- ✏️ Replace with actual screenshots -->
                <img src="ugc/ugc1.png" class="screenshot-img" id="mainImg" alt="UGC Management System Screenshot">
                <div class="zoom-hint"><i class="fas fa-search-plus"></i></div>
            </div>

            <div class="thumb-strip">
                <div class="thumb active" onclick="setActive(this, 'ugc/ugc1.png')">
                    <img src="ugc/ugc2.png" alt="Creator Tracker">
                </div>
                <div class="thumb" onclick="setActive(this, 'ugc/ugc2.png')">
                    <img src="ugc/ugc3.png" alt="Dashboard">
                </div>
                <div class="thumb" onclick="setActive(this, 'ugc/ugc3.png')">
                    <img src="ugc/ugc4.png" alt="Content Pipeline">
                </div>
            </div>
        </div>
        ...
        <div class="content-grid">
            <div class="desc-block reveal">
                ...
                <p class="desc-text">This web-based UGC Management System was built to centralize the entire creator workflow in one platform. From initial outreach to content submission, review, and payment — every stage is tracked and managed through a clean, role-based web interface.</p>
                <p class="desc-text">Built with PHP and MySQL, the system handles multiple creators and campaigns simultaneously, with real-time status updates and a dashboard that gives the team instant visibility over all active and pending content.</p>
                ...
                <ul class="feature-list">
                    <li>Creator database with profile, niche, platform, and rate management</li>
                    <li>Full pipeline tracking: Outreach → Negotiation → Content → Review → Published</li>
                    <li>Content deliverables management with due dates and submission links</li>
                    <li>Payment tracking and status management per creator</li>
                    <li>Campaign management with multiple creators per campaign</li>
                    <li>Role-based access control for admins and team members</li>
                    <li>Dashboard with active campaigns, pending content, and payment summary</li>
                </ul>
            </div>
            ...
            <div class="sidebar">
                ...
                <div class="sidebar-card reveal" style="transition-delay:0.15s">
                    ...
                    <div class="info-row"><span class="info-key">Category</span><span class="info-val">UGC / Creator CRM</span></div>
                    <div class="info-row"><span class="info-key">Client</span><span class="info-val">Private</span></div>
                ...
                <div class="cta-card reveal" style="transition-delay:0.2s">
                    <h4>Need a UGC system?</h4>
                    <p>I can build a custom creator management workflow for your brand.</p>
    ...
    <div class="related-section">
        <div class="related-inner">
            ...
            <div class="related-grid">
                <a href="project-sheets-freesample.php" class="related-card">
                    <div class="related-thumb"><i class="fas fa-box-open"></i></div>
                    <div class="related-info">
                        <div class="related-title">Free Sample Monitoring</div>
                        <div class="related-cat">Google Sheets · Tracker</div>
                    </div>
                </a>
